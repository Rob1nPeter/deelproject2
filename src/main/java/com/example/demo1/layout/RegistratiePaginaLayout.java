...
public class RegistratiePaginaLayout {
    ...
    public void gebruikersNaamR(Pane root) {
        ...
        gebruikersNaamRegistratie.setPromptText(translate("gebruikersnaam"));
    ...
    public void WachtwoordR(Pane root) {
        ...
        wachtwoordRegistratie.setPromptText(translate("wachtwoord"));
    ...
    public void RegistreerOkButton(Pane root) {
        Button RegistreerOkButton = new Button(translate("registreer"));
